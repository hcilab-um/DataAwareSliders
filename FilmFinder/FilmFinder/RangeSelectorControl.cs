...
namespace FilmFinder
{
    ...
    //[ToolboxBitmap(typeof(RangeSelectorControl.RangeSelectorControl), "RangeScale.bmp")]
    public class RangeSelectorControl : UserControl
    {
         ...
         protected override void OnPaint(PaintEventArgs e)
         {
             ...
             try
             {
                 ...
                 OnChangedValues(new RangeChangedEventArgs(strRange1, strRange2));
             }
             catch
             {
        ...
        public event RangedValuesChangedEventHandler ChangedValues;
        protected virtual void OnChangedValues(RangeChangedEventArgs e)
        {
            if(ChangedValues != null)
                ChangedValues(this, e);
        }
     }
    ...
    public delegate void RangedValuesChangedEventHandler(object sender, RangeChangedEventArgs e);

    public class RangeChangedEventArgs : EventArgs
    {
        private string strRange1, strRange2;

        public RangeChangedEventArgs(string r1, string r2)
        {
            strRange1 = r1;
            strRange2 = r2;
        }
